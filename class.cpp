...
void do_start ( Character * ch )
{
	...
	SET_BIT_AR ( PRF_FLAGS ( ch ), PRF_NOTITLE );
	SET_BIT_AR ( PRF_FLAGS ( ch ), PRF_AUTOSPLIT );
	SET_BIT_AR ( PRF_FLAGS ( ch ), PRF_BATTLESPAM );
	SET_BIT_AR ( PRF_FLAGS ( ch ), PRF_MOVEMSG );
...
void init_spell_levels ( void )
{
	...
	assign_class ( SPELL_LOCATE_OBJECT,    ALL_CASTERS | GYP | RAN);
	assign_class ( SPELL_STRENGTH,         ALL_CASTERS );
	...
	assign_class ( SPELL_SHIELD_MIRROR,    MAG | ESP );
	...
	assign_class ( SPELL_STEELSKIN,           ALL_CASTERS );
	...
	assign_class ( SPELL_MANA_BLAST,       ESP );
	assign_class ( SPELL_GROUP_SHIELD,     ALL_CASTERS );
	assign_class ( SPELL_EARTH_ELEMENTAL,  ESP );
	assign_class ( SPELL_INFERNO,          MAG );
	assign_class ( SPELL_CURE_LIGHT,        ALL_CASTERS | HUN );
	...
	assign_class ( SPELL_GROUP_ARMOR,       ALL_CASTERS );
	assign_class ( SPELL_CURE_CRITIC,       PRI | HUN );
	assign_class ( SPELL_SUMMON,            PRI | ESP );
	assign_class ( SPELL_ANTIDOTE_1,        PRI | HUN );
	assign_class ( SPELL_SHIELD_THORN,      MAG | ESP );
	...
	assign_class ( SKILL_FACE,         ALL_CLASSES );
