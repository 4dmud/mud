...
// Added these for Molly
    ...
    subo(SUB_GAFFER, "Gaffer", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_AUTO| SUB_TYPE_PROF, CL_TYPE_NONE, PROF_GLASSWORKER);
    ...
    subo(SUB_TANNER, "Tanner", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_AUTO| SUB_TYPE_PROF, CL_TYPE_NONE, PROF_LEATHERWORKER);
    ...
    subo(SUB_METALLURGIST, "Metallurgist", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_AUTO| SUB_TYPE_PROF, CL_TYPE_NONE, PROF_METALWORKER);
    ...
    subo(SUB_QUARRIER, "Quarrier", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_AUTO| SUB_TYPE_PROF, CL_TYPE_NONE, PROF_STONEWORKER);
    ...
    subo(SUB_WEAVER, "Weaver", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_AUTO| SUB_TYPE_PROF, CL_TYPE_NONE, PROF_TEXTILEWORKER);
    ...
    subo(SUB_WOODSMAN, "Woodsman", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_AUTO| SUB_TYPE_PROF, CL_TYPE_NONE, PROF_WOODWORKER);
