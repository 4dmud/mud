...
// Added these for Molly
	...
	0, POS_SITTING, 0, PEAC,
	SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_ARTISAN);
    
    subo(SUB_PAINTER, "Painter", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_ARTISAN);

    subo(SUB_REPAIRMAN, "Repairman", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_ARTISAN);

    subo(SUB_SCULPTOR, "Sculptor", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_ARTISAN);

    subo(SUB_POTTER, "Potter", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_BREWER);
    ...
    subo(SUB_GAFFER, "Gaffer", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_GLASSWORKER);

    subo(SUB_GLAZIER, "Glazier", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_GLASSWORKER);
    ...
    subo(SUB_TANNER, "Tanner", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_LEATHERWORKER);
    ...
    subo(SUB_METALLURGIST, "Metallurgist", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_METALWORKER);

    subo(SUB_BLACKSMITH, "Black Smith", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_METALWORKER);

     subo(SUB_FARRIER, "Farrier", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_METALWORKER);
    ...
    subo(SUB_QUARRIER, "Quarrier", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_STONEWORKER);

    subo(SUB_MASONER, "Masoner", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_STONEWORKER);
    ...
    subo(SUB_CONSTRUCTOR, "Constructor", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_STONEWORKER);

    subo(SUB_WEAVER, "Weaver", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_TEXTILEWORKER);
     ...
     subo(SUB_EMBROIDERER, "Embroiderer", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_TEXTILEWORKER);

    subo(SUB_WOODSMAN, "Woodsman", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_WOODWORKER);

     subo(SUB_MILLER, "Miller", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_WOODWORKER);

     subo(SUB_CARPENTER, "Carpenter", 0, 0,
        0, POS_SITTING, 0, PEAC,
        SK_NONE, STATUS_TYPE_TRAINABLE, SUB_TYPE_CMD, CL_TYPE_NONE, PROF_WOODWORKER);
