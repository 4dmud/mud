...
#define MUDLET_PACKAGE "2\nhttp://www.godwars2.org/download/mudlet/4D_GUI.mpackage"
...
typedef struct
{
   ...
   int       LastRoomVnum;     /* Molly doesn't want this as an MSDP variable */
...
/* Function: MCCPBegin
 *
 * Begins compression, as long as MCCP2 has been successfully negotiated.
 */
