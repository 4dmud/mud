...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        uint32 lhs = l;
        // make sure requires clause is not broken
        CASSERT( !(static_cast<uint16>(lhs) < rhs) && lhs <= 65535,
            "\tconst bigint operator-(uint16,const bigint&)"
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        uint32 rhs = r;
        // make sure requires clause is not broken
        CASSERT( !(lhs < static_cast<uint16>(rhs)) && rhs <= 65535,
            "\tconst bigint operator-(const bigint&,uint16)"
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        uint32 rhs = r;
        // make sure requires clause is not broken
        CASSERT( !(*this < static_cast<uint16>(rhs)) && rhs <= 65535,
            "\tbigint& bigint::operator-=(uint16)"
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // make sure requires clause is not broken
        CASSERT( !(rhs == 0) && static_cast<uint32>(rhs) <= 65535,
            "\tbigint& bigint::operator/=(uint16)"
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // make sure requires clause is not broken
        CASSERT( !(rhs == 0) && static_cast<uint32>(lhs) <= 65535,
            "\tconst bigint operator%(uint16,const bigint&)"
