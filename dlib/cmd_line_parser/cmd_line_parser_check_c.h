...
// ----------------------------------------------------------------------------------------
    ...
    ) const
    {
        ...
        CASSERT( this->parsed_line() == true && this->option_is_defined(option_name),
...
// ----------------------------------------------------------------------------------------
    ...
    ) const
    {
        ...
        {
            CASSERT( this->parsed_line() == true && this->option_is_defined(option_set[i]), 
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // make sure requires clause is not broken
        CASSERT( this->parsed_line() == true && this->option_is_defined(option_name1) &&
...
// ----------------------------------------------------------------------------------------
    ...
    ) const
    {
        ...
        for (size_t i = 0; i < length; ++i)
        {
            CASSERT( this->option_is_defined(sub_option_set[i]), 
        ...
        CASSERT( this->parsed_line() == true && this->option_is_defined(parent_option), 
                 "\tvoid cmd_line_parser_check::check_sub_options()"
                 << "\n\tSee the requires clause for this function."
                 << "\n\tthis:                             " << this
...
// ----------------------------------------------------------------------------------------
    ...
    ) const
    {
        ...
        for (size_t i = 0; i < length; ++i)
        {
            CASSERT( this->option_is_defined(parent_option_set[i]), 
                     "\tvoid cmd_line_parser_check::check_sub_options()"
                     << "\n\tSee the requires clause for this function."
                     << "\n\tthis:                                    " << this
        ...
        CASSERT( this->parsed_line() == true && this->option_is_defined(sub_option), 
                 "\tvoid cmd_line_parser_check::check_sub_options()"
                 << "\n\tSee the requires clause for this function."
                 << "\n\tthis:                          " << this
