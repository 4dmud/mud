    ...
    public:
        ...
        /*!
            requires
                - index < size()
            ensures 
                - returns an id number that inuquely references the element at the given index.
                  (you can use this id to locate the new position of an element after
                  the buffer has been rotated)
        ...
        /*!
            ...
            ensures
                - returns the index of the element with the given id.
                  ( (*this)[get_element_index(id)] will always refer to the same element
