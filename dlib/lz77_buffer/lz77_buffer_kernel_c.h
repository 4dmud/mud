...
namespace dlib
{
    ...
    class lz77_buffer_kernel_c : public lz77_base
    {
        ...
        !*/
        {
            ...
            CASSERT( 6 < total_limit && total_limit < 32 &&
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // make sure requires clause is not broken
        CASSERT( N <= this->get_lookahead_buffer_size(),
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // make sure requires clause is not broken
        CASSERT( index < this->get_history_buffer_size(),
...
// ----------------------------------------------------------------------------------------
    ...
    {
        // make sure requires clause is not broken
        CASSERT( index < this->get_lookahead_buffer_size(),
