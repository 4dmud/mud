...
namespace  
{
    ...
    {        
        ...
        try 
        {
            ...
            for (int k = 0; k < 100; ++k)
            {
                ...
                CASSERT(short_fact_squared<bint>(k) == c,"k: " << k);
                print_spinner();
            }
            ...
            a = big_fact<bint>(20);
            sout << a;
            CASSERT( sout.str() == "2432902008176640000","was: " << a);
            
            sin.str("684626312793279327952039475203945");
            sin >> a;
            sout.str("");
            sout << a;
            CASSERT(sout.str() == "684626312793279327952039475203945","");
            ...
            CASSERT(sin.fail() == false, "");
            sin.str("the cat ate some cheese");
            sin >> a;
            CASSERT(sin.fail() == true, "");
            sin.clear();
            sin.str("");
            ...
            sin.str("3628913");
            sin >> i;
            CASSERT(short_fact<bint>(10) + short_fact<bint>(5) - 7 == i,"");

            sin.str("2432902008173011193");
            sin >> i;
            CASSERT(short_fact<bint>(20) - short_fact<bint>(10) - 7 == i,"");
            ...
            a = b;
            ++b;
            CASSERT ( a + 1 == b,"a==" << a << endl << "b==" << b << endl);
            ...
            CASSERT(a == b*(b+1)/2, "a==" << a << endl << "b*(b+1)/2==" << b*(b+1)/2 << endl);
            ...
            CASSERT(short_fact<bint>(10)/short_fact<bint>(5) == 30240,"");
            CASSERT(short_fact<bint>(10)/(short_fact<bint>(5)+1) == 29990,"");

            sin.str("221172909834240000");
            sin >> a;
            CASSERT(short_fact<bint>(20)/(short_fact<bint>(5)+1) == a/11,"");
            
            sin.str("670442388044");
            sin >> b;
            CASSERT(short_fact<bint>(20)/(short_fact<bint>(10)+1) == b,"");
            
            print_spinner();

            sin.str("1860479");
            sin >> i;
            CASSERT(short_fact<bint>(20)/(short_fact<bint>(15)+1) == i,short_fact<bint>(20)/(short_fact<bint>(15)+1));
            ...
            CASSERT(short_fact<bint>(10000)/short_fact<bint>(9999) == 10000,"");
            

            CASSERT(bint(5)%bint(1) == 0,"");
            CASSERT(bint(5)%bint(6) == 5,"");
            CASSERT(bint(25)%bint(6) == 1,"");
            print_spinner();
            CASSERT(bint(354)%bint(123) == 108,"");
            CASSERT(bint(20)%(bint(10)) == 0,"");
            CASSERT(bint(20)%(bint(10)+1) == 9,"");

            CASSERT(bint(20)%(bint(15)+1) == 4,"");


            CASSERT(short_fact<bint>(10)%(short_fact<bint>(5)+2) == 32,"");

            sin.str("2908082");
            sin >> i;
            CASSERT(short_fact<bint>(15)%(short_fact<bint>(10)+2) == i,"");
            ...
            CASSERT(big_fact<bint>(10)%(big_fact<bint>(5)+2) == 32,"");

            sin.str("2908082");
            sin >> i;
            CASSERT(big_fact<bint>(15)%(big_fact<bint>(10)+2) == i,"");


            print_spinner();


            CASSERT(big_fact<bint>(10)/big_fact<bint>(5) == 30240,"");
            CASSERT(big_fact<bint>(10)/(big_fact<bint>(5)+1) == 29990,"");

            sin.str("221172909834240000");
            sin >> a;
            CASSERT(big_fact<bint>(20)/(big_fact<bint>(5)+1) == a/11,"");
            

            sin.str("670442388044");
            sin >> b;
            CASSERT(big_fact<bint>(20)/(big_fact<bint>(10)+1) == b,"");
            

            sin.str("1860479");
            sin >> i;
            CASSERT(big_fact<bint>(20)/(big_fact<bint>(15)+1) == i,big_fact<bint>(20)/(big_fact<bint>(15)+1));
            
            CASSERT(big_fact<bint>(100)/big_fact<bint>(99) == 100,"");
    ...
    public:
        ...
        )
        {
            ...
            n += bigint_kernel_test<bigint::kernel_1a>    ("kernel_1a");
            print_spinner();
            dlog << LINFO << "testing kernel_1a_c";
            n += bigint_kernel_test<bigint::kernel_1a_c>  ("kernel_1a_c");
            print_spinner();
            dlog << LINFO << "testing kernel_2a";
            n += bigint_kernel_test<bigint::kernel_2a>    ("kernel_2a");
            print_spinner();
            dlog << LINFO << "testing kernel_2a_c";
            n += bigint_kernel_test<bigint::kernel_2a_c>  ("kernel_2a_c");
            print_spinner();
            return (n == 0);
        }
    } a;
