...
namespace  
{
    ...
    /*!
        ...
        ensures
            ...
            - returns 0 if no errors were found, returns 1 otherwise.
    !*/
    {        
    ...
    public:
        ...
        {
            int n = 0;
            n += map_kernel_test<dlib::map<int,int>::kernel_1a>    ("kernel_1a");
            print_spinner();
            n += map_kernel_test<dlib::map<int,int>::kernel_1a_c>  ("kernel_1a_c");
            print_spinner();
            n += map_kernel_test<dlib::map<int,int>::kernel_1b>    ("kernel_1b");
            print_spinner();
            n += map_kernel_test<dlib::map<int,int>::kernel_1b_c>  ("kernel_1b_c");
            print_spinner();
            return (n == 0);
        }
    } a;
