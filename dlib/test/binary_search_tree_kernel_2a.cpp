...
namespace  
{
    ...
    public:
        ...
        {
            int n = 0;
            n += binary_search_tree_kernel_test<binary_search_tree<int,int>::kernel_2a>    ("kernel_2a");
            print_spinner();
            n += binary_search_tree_kernel_test<binary_search_tree<int,int>::kernel_2a_c>  ("kernel_2a_c");
            print_spinner();
            return (n == 0);
        }
    } a;
