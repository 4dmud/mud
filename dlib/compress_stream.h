...
namespace dlib
{
    ...
    public:
        ...
        // kernel_1a        
        typedef      compress_stream_kernel_1 <fce1,fcd1>
                     kernel_1a;
   
        // kernel_1b        
        typedef      compress_stream_kernel_1 <fce2,fcd2>
                     kernel_1b;

        // kernel_1c        
        typedef      compress_stream_kernel_1 <fce3,fcd3>
                     kernel_1c;

        // kernel_1da        
        typedef      compress_stream_kernel_1 <fce4a,fcd4a>
                     kernel_1da;

        // kernel_1ea        
        typedef      compress_stream_kernel_1 <fce5a,fcd5a>
                     kernel_1ea;

        // kernel_1db        
        typedef      compress_stream_kernel_1 <fce4b,fcd4b>
                     kernel_1db;

        // kernel_1eb        
        typedef      compress_stream_kernel_1 <fce5b,fcd5b>
                     kernel_1eb;

        // kernel_1ec        
        typedef      compress_stream_kernel_1 <fce5c,fcd5c>
                     kernel_1ec;
        ...
        // kernel_2a        
        typedef      compress_stream_kernel_2 <fce2,fcd2,lz77_buffer2a,sliding_buffer1,fce_length,fcd_length,fce_index,fcd_index>
                     kernel_2a;
