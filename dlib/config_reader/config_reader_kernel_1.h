...
// ----------------------------------------------------------------------------------------
    ...
    /* 
        This is a bunch of crap so we can enable and disable the CASSERT statements
    ...
    */
    namespace config_reader_kernel_1_helpers
    {
        ...
        struct helper<cr_type,true>
        {
            ...
            {
                CASSERT ( cr.is_key_defined(key) == true ,
            ...
            {
                CASSERT ( cr.is_block_defined(name) == true ,
            ...
            static void check_current_block_name_precondition (const cr_type& cr) 
            {
                CASSERT ( cr.current_element_valid() == true ,
