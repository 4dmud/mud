        ...
        if (!IS_NPC(ch) && PRF_FLAGGED(ch, PRF_NOREPEAT)) {
            ...
            if (argument[len - 1] == '?') {
                ...
                snprintf(to_vict, sizeof(to_vict), "$n winks at you and says, '%s'", argument);
                       ...
                       && argument[len - 3] == ' ') {
                argument[len - 3] = '\0';
                snprintf(to_char, sizeof(to_char), "You frown at $N and say, '%s'", argument);
                snprintf(to_room, sizeof(to_room), "$n frowns at $N and says, '%s'", argument);
                snprintf(to_vict, sizeof(to_vict), "$n frowns at you and says, '%s'", argument);
