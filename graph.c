...
char tbuf[MAX_STRING_LENGTH];
 ...
 switch (number(0, 20)) {
 case 0:
 new_send_to_char(HUNTING(ch), "You sense something nearby, coming for you.\r\n");
 break;
 case 1:
 new_send_to_char(HUNTING(ch), "You see an unfriendly face in the distance.\r\n");
 break;
case 2:
 new_send_to_char(HUNTING(ch), "You have a nasty feeling of danger lurking about.\r\n");
 break;
 }
