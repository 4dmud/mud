...
#define EXPLOREPOINTS(ch)      CHECK_PLAYER_SPECIAL((ch), (SPECIALS(ch)->saved.explorepoints))
...
#define GET_OBJ_FLOATING_VAL(obj, val)	  ((obj)->obj_flags.floating_value[(val)])
...
// #define GET_V_ROOM_INSIDE(obj)    GET_OBJ_VAL(obj, 0)
#define GET_V_SPEED(obj)          GET_OBJ_VAL(obj, 0)
#define GET_V_SHIELD(obj)         GET_OBJ_VAL(obj, 2)
#define GET_V_HP(obj)             GET_OBJ_VAL(obj, 3)
#define GET_V_MAX_FUEL(obj)       GET_OBJ_VAL(obj, 4)
#define GET_V_FUEL(obj)           GET_OBJ_VAL(obj, 5)
#define GET_GEM_FUEL(obj)	  GET_OBJ_VAL(obj, 0)
#define GET_OBJ_MATERIAL(obj)   GET_OBJ_VAL(obj, 8)
...
#define GET_OBJ_COLOUR(obj)     GET_OBJ_VAL(obj, 7)
#define GET_OBJ_QUALITY(obj)    GET_OBJ_FLOATING_VAL(obj, 0)
#define GET_OBJ_DYECOUNT(obj)   GET_OBJ_VAL(obj, 9)
#define GET_OBJ_ORIGIN(obj)     GET_OBJ_VAL(obj, 10)
#define GET_OBJ_STAGE(obj)      GET_OBJ_VAL(obj, 11)
#define GET_OBJ_REPAIRS(obj)    GET_OBJ_VAL(obj, 12)
