...
OBJFILES = act.comm.o act.create.o act.informative.o act.item.o \
	...
	math.o mobact.o modify.o molly.o mordecai.o medit.o \
	name.map.o note.o objsave.o oedit.o \
	...
	spec_procs.o spell_parser.o subskills.o spells.o string.o cppstring.o strutil.o \
	trainers.o task.o trees.o \
...
CXREF_FILES = act.comm.c act.create.c act.informative.c act.item.c \
	...
	math.c mobact.c modify.c molly.c mordecai.c medit.c \
	name.map.c note.c objsave.c oedit.c \
	...
	cppstring.cpp strutil.cpp trainers.cpp task.c trees.c \
