...
struct shop_data {
    ...
    mob_vnum keeper;		/* The mobile who owns the shop (vnum)  */
...
#define TRADE_NOMAGE            (1 <<  3)
#define TRADE_NOPRIEST          (1 <<  4)
#define TRADE_NOTHIEF           (1 <<  5)
#define TRADE_NOWARRIOR         (1 <<  6)
#define TRADE_NOFAUN            (1 <<  7)
#define TRADE_NOCENTAUR         (1 <<  8)
#define TRADE_NOELF             (1 <<  9)
#define TRADE_NODWARF           (1 << 10)
#define TRADE_NOINDIAN          (1 << 11)
#define TRADE_NOGRINGO          (1 << 12)
#define TRADE_NOMARTIAN         (1 << 13)
#define TRADE_NOSPACE_WOLF      (1 << 14)
#define TRADE_NOHUNTER          (1 << 15)
#define TRADE_NOGYPSY           (1 << 16)
#define TRADE_NORANGER          (1 << 17)
#define TRADE_NOESPER           (1 << 18)
...
#define NOTRADE_HUNTER(i)       (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOHUNTER))
#define NOTRADE_GYPSY(i)        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOGYPSY))
#define NOTRADE_RANGER(i)       (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NORANGER))
#define NOTRADE_ESPER(i)        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOESPER))
#define NOTRADE_FAUN(i)         (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOFAUN))
#define NOTRADE_CENTAUR(i)      (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOCENTAUR))
#define NOTRADE_ELF(i)          (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOELF))
#define NOTRADE_DWARF(i)        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NODWARF))
#define NOTRADE_INDIAN(i)       (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOINDIAN))
#define NOTRADE_GRINGO(i)       (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOGRINGO))
#define NOTRADE_MARTIAN(i)      (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOMARTIAN))
#define NOTRADE_SPACE_WOLF(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOSPACE_WOLF))
